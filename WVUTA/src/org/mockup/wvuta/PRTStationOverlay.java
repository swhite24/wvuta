...
public class PRTStationOverlay extends ItemizedOverlay<OverlayItem>{
	...
	public void draw(Canvas canvas, MapView mapView, boolean shadow) {
		...
		if (!shadow) {
			...
			while(iterator.hasNext()){
				...
				RectF backrect = new RectF(point.x + 2 + radius, point.y - 3 * radius + 1,
						point.x + 67, point.y + radius);
	...
	private String getName(int count) {
		switch(count){
		case 0: return Constants.BEECHURST;
		case 1: return Constants.ENGINEERING;
		case 2: return Constants.MEDICAL;
		case 3: return Constants.TOWERS;
		case 4: return Constants.WALNUT;
		}
		return null;
	}
	...
	public boolean onTap(int index) {
		...
		sb.append("Inbound cars: \n");
		sb.append("Outbound cars: \n");
